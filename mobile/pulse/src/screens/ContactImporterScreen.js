...
async function apiRequest(path, options = {}) {
  const token = await AsyncStorage.getItem('pulse_token');
        ...
        ListHeaderComponent={
          <View style={styles.content}>
            <View style={styles.card}>
              ...
              <TextInput style={styles.input} placeholder="Name" placeholderTextColor="#8899a6" value={manualName} onChangeText={setManualName} />
              <TextInput style={styles.input} placeholder="Phone (optional)" placeholderTextColor="#8899a6" value={manualPhone} onChangeText={setManualPhone} />
              <TextInput style={styles.input} placeholder="Email (optional)" placeholderTextColor="#8899a6" value={manualEmail} onChangeText={setManualEmail} />
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 50, paddingBottom: 14, paddingHorizontal: 16, backgroundColor: '#16213e' },
  backBtn: { padding: 4 },
  ...
  input: { backgroundColor: '#2a2a4a', borderRadius: 8, padding: 12, color: '#fff', fontSize: 14, marginBottom: 8 },
  btn: { backgroundColor: '#8b5cf6', borderRadius: 8, padding: 12, alignItems: 'center' },
  ...
  contactItem: { flexDirection: 'row', alignItems: 'center', padding: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#2a2a4a' },
  contactAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#2a2a4a', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  ...
  contactDetail: { color: '#8899a6', fontSize: 12, marginTop: 2 },
  deleteBtn: { padding: 4 },
  emptyText: { color: '#8899a6', textAlign: 'center', marginTop: 40, fontSize: 14 },
});
