...
const styles = StyleSheet.create({
  ...
  parentMsg: { padding: 12, margin: 12, backgroundColor: '#e7f3ff', borderRadius: 12, borderLeftWidth: 3, borderLeftColor: '#0a66c2' },
  ...
  ownMsg: { alignSelf: 'flex-end', backgroundColor: '#0a66c2' },
  ...
  sendBtn: { backgroundColor: '#0a66c2', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20, justifyContent: 'center' },
