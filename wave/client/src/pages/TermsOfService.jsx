export default function TermsOfService() {
  return (
    <div className="page-container" style={{ minHeight: '100vh', padding: '24px 16px', maxWidth: 720, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }}>Terms of Service</h1>
