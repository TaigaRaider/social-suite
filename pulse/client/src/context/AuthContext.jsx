...
export function AuthProvider({ children }) {
  ...
  const flushOfflineQueue = () => {
    ...
    queue.forEach(msg => {
      api.sendMessage(msg.conversationId, msg.content).catch(() => {});
    });
  };
  ...
  return (
    <AuthContext.Provider value={{ user, loading, login, register, logout, updateUser, loadUser, isOnline, queueMessage }}>
      {children}
